...
namespace asd
{
template <class RESOURCE> class ResourceContainer
{
public:
...
public:
	...
	*/
	time_t GetModifiedTime(const achar* path)
	{
		...
		file = CreateFileW((const wchar_t*)path, GENERIC_READ, 0, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, 0);
