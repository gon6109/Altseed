...
with aceutils.CurrentDir('../Downloads'):
    ...
    with aceutils.CurrentDir('freetype_bin'):
        if aceutils.isWin():
            ...
            aceutils.call(r'cmake -G "Unix Makefiles" "-DWITH_BZip2=OFF" "-DWITH_HarfBuzz=OFF" "-DCMAKE_OSX_ARCHITECTURES=x86_64' +
                          (';i386' if aceutils.Isi386() else '') + r'" -D CMAKE_BUILD_TYPE=Release ../freetype/')
